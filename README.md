...
Tori's starting point for Neovim from kickstart.
## Installation
...
```sh
git clone https://github.com/VicBriar/kickstart.nvim.git ${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```

</details>

<details><summary> Windows (untested, keeping just in case) </summary>
...
> open kitty
> command + enter twice
Get around with control+shift+[ and control+shift+]

# TODO
- make a dotfile repo for kitty
  - configure kitty to open new windows in the same place as last window
- configure markdown-render
